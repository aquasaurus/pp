<template>
  <div class="flex flex-col space-y-8">
    <div class="bg-gray-800 text-white min-h-screen">
      <div
        class="flex flex-col space-y-4 px-4 py-12 mt-24 lg:mt-72 max-w-8xl mx-auto justify-center h-full"
        data-aos="fade-up"
        data-aos-easing="linear"
        data-aos-delay="100"
        data-aos-duration="260"
      >
        <span class="text-7xl">We Help</span>
        <span class="text-7xl">Our People</span>
        <button class="bg-blue-500 rounded-full px-4 py-1 w-48">
          Learn More
        </button>
      </div>
    </div>
    <div class="flex flex-col space-y-4 px-4 max-w-7xl mx-auto py-12">
      <div
        data-aos="fade-up"
        data-aos-easing="linear"
        data-aos-delay="100"
    ...
    >
      <div
        class="bg-gray-800 rounded-xl text-right p-2 lg:p-8 flex flex-col space-y-8 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"
      >
      ...
      <div
        class="bg-gray-700 rounded-xl text-left p-2 lg:p-8 flex flex-col space-y-8 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"
      >
    ...
    <div
      class="bg-blue-100 w-full py-12 mx-auto"
    >
